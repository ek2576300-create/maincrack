  ...
  return lang === 'ru' ? [
    {
      ...
      body: [
        ...
        'Не более 3 навыков могут висеть на одной характеристике (Сила / Проворство / Интеллект / Выносливость / Дух / Удача). Закреплённый талант тоже считается в этот лимит.',
